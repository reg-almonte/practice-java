...
public class JavaBasic {
	...
	public static void main(String[] args) {
		...
		// Variables
		System.out.println("These are the java variables you can use:");
	...
	static void primitiveDataTypes() {
		...
		*/	
		...
		/* 1.1 byte: The byte data type is an 8-bit signed two's complement integer. It has a minimum value of -128 and a maximum 
		...
		/* 1.2 short: The short data type is a 16-bit signed two's complement integer. It has a minimum value of -32,768  
		...
		/* 1.3 int: By default, the int data type is a 32-bit signed two's complement integer, which has a minimum value of
		...
		/* 1.4 long: The long data type is a 64-bit two's complement integer. The signed long has a minimum value of -2^63 
		...
		/* 1.5 float: The float data type is a single-precision 32-bit IEEE 754 floating point. Its range of values is 
		...
		/* 1.6 double: The double data type is a double-precision 64-bit IEEE 754 floating point. Its range of values is 
		 * beyond the scope of this discussion, but is specified in the Floating-Point Types, Formats, and Values section 
		...
		/* 1.7 boolean: The boolean data type has only two possible values: true and false. Use this data type for simple 
		...
		/* 1.8 char: The char data type is a single 16-bit Unicode character. It has a minimum value of '\u0000' (or 0) and
		...
		/* 1.9 String (Capital S): In addition to the eight primitive data types listed above, the Java programming language 
